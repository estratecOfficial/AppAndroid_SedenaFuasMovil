...
public class ShowDataActivityISSSTE extends AppCompatActivity implements SearchView.OnQueryTextListener {
    SQLiteHelperISSSTE sqLiteHelperISSSTE;
    SQLiteDatabase sqLiteDatabase;
    Cursor cursor;
    ListAdapterISSSTE listAdapterISSSTE ;
    ListView LISTVIEW;
    SearchView searchView;
    ArrayList<seriesISSSTE> seriesList =  new ArrayList<>();
    ArrayList<String> ListViewClickItemArray = new ArrayList<String>();
    String estatusCompleto = "Completo", estatusEnCola="En cola",tecnicoReceibe;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_show_data_issste);
        setTitle("ISSSTE");


        searchView=(SearchView) findViewById(R.id.searchViewISSSTE);
        LISTVIEW = (ListView) findViewById(R.id.listView1ISSSTE);
        ...
        LISTVIEW.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ShowDataActivityISSSTE.this, ListViewClickItemArray.get(position).toString(), Toast.LENGTH_LONG).show();
            }
        });
        ShowSQLiteDBdata();
    }
    ...
    private void ShowSQLiteDBdata() {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM "+SQLiteHelperISSSTE.TABLE_NAME+" WHERE Estatus !='" + estatusCompleto +"' AND Estatus !='" + estatusEnCola +"'" , null);
        int contador = 0;
        ...
        if (contador == 0){
            showAlertDialogInternet(this, "NO HAS SINCRONIZADO TUS SERIES",
                    "Para ver el listado de series disponibles es necesario presionar el botón Obtener Series", true);
        }
        else{
            listAdapterISSSTE = new ListAdapterISSSTE(ShowDataActivityISSSTE.this, seriesList);
            LISTVIEW.setAdapter(listAdapterISSSTE);
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(ShowDataActivityISSSTE.this, main_activity_issste.class);
