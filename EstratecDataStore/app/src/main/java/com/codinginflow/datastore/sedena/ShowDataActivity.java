...
public class ShowDataActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void ShowSQLiteDBdata() {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM "+SQLiteHelper.TABLE_NAME+" WHERE Estatus !='" + estatusCompleto +"' AND Estatus !='" + estatusEnCola +"'" , null);
        int contador = 0;
        ...
        if (contador == 0){
            ...
            listAdapter = new com.codinginflow.datastore.sedena.ListAdapter(ShowDataActivity.this, seriesList);
